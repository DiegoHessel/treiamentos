...
import com.example.treinamento.dto.AtualizacaoStatusPedidoDTO;
import com.example.treinamento.dto.InformacaoItemPedidoDTO;
import com.example.treinamento.dto.InformacoesPedidoDTO;
...
public class PedidoController {
    ...
    public InformacoesPedidoDTO getById(@PathVariable Integer id) {
        InformacoesPedidoDTO pedidoNaoEncontrado = service.obterPedidoCompleto(id)
                .map(p -> converter(p))
